...
if not hasattr(st.session_state, "authenticated") or not st.session_state.authenticated:
    ...
    if st.session_state.authenticated and st.session_state.client and not st.session_state.enhanced_client:
        st.session_state.enhanced_client = BoxAPIClientEnhanced(st.session_state.client)
    ...
    if not hasattr(st.session_state, "current_page") or st.session_state.current_page == "Home":
        ...
        with col2:
            ...
            features = [
                ...
                "🏷️ Custom document categorization",
        ...
        with col2:
            if st.button("Configure Document Types", use_container_width=True, key="quick_doc_types"):
                navigate_to("Document Types")
                st.rerun()
